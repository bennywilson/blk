...
kbRenderer_DX11::kbRenderer_DX11() :
	...
	m_pSkinnedDirectionalLightShadowShader = new kbShader("../../blk_engine//assets/Shaders/directionalLightSkinnedShadow.kbShader");
	m_pBloomGatherShader = new kbShader("../../blk_engine//assets/Shaders/bloom.kbShader");
	m_pBloomBlur = new kbShader("../../blk_engine//assets/Shaders/bloom.kbShader");
...
void kbRenderer_DX11::Init_Internal(HWND hwnd, const int frameWidth, const int frameHeight) {
	...
	*/
	...
	// Load some shaders
	m_pBasicShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/BasicShader.kbshader", true, true);
	m_pOpaqueQuadShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/basicTexture.kbshader", true, true);
	m_pTranslucentShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/basicTranslucency.kbshader", true, true);
	m_pScreenTintShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/screenTint.kbShader", true, true);
	m_pMultiplyBlendShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/basicMultiplyBlend.kbshader", true, true);
	m_pBasicParticleShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/basicParticle.kbshader", true, true);
	m_pMissingShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/missingShader.kbshader", true, true);
	m_pDebugShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/debugShader.kbshader", true, true);

	m_pUberPostProcess = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/UberPostProcess.kbshader", true, true);
	m_pDirectionalLightShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/DirectionalLight.kbshader", true, true);
	m_pPointLightShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/PointLight.kbshader", true, true);
	m_pCylindricalLightShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/cylindricalLight.kbshader", true, true);

	m_pDirectionalLightShadowShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/directionalLightShadow.kbshader", true, true);
	m_pLightShaftsShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/lightShafts.kbshader", true, true);
	m_pSimpleAdditiveShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/simpleAdditive.kbshader", true, true);
	m_pGodRayIterationShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/godRayIteration.kbShader", true, true);

	m_pMousePickerIdShader = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/mousePicker.kbshader", true, true);

	m_pSSAO = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/SSAO.kbShader", true, true);

	m_pBasicFont = (kbShader*)g_ResourceManager.GetResource("../../blk_engine//assets/Shaders/basicFont.kbShader", true, true);
	...
	LoadTexture("../../blk_engine//assets/Textures/Editor/white.bmp", 0);
	...
	LoadTexture("../../blk_engine//assets/Textures/textbackground.dds", 3);
	LoadTexture("../../blk_engine//assets/Textures/Font.bmp", 4);
...
void kbRenderer_DX11::ReadShaderFile(std::string& shaderText, kbShaderVarBindings_t* const pShaderBindings) {
	...
	// Param defaults
	kbTexture* const pWhiteTex = (kbTexture*)g_ResourceManager.GetResource("../../blk_engine//assets/Textures/white.bmp", true, true);
	kbTexture* const pBlackTex = (kbTexture*)g_ResourceManager.GetResource("../../blk_engine//assets/Textures/black_alpha.tif", true, true);
	kbTexture* const pDefaultNormal = (kbTexture*)g_ResourceManager.GetResource("../../blk_engine//assets/Textures/defaultNormal.bmp", true, true);
	kbTexture* const pNoiseTex = (kbTexture*)g_ResourceManager.GetResource("../../blk_engine//assets/Textures/noise.jpg", true, true);

...
public:
	...
	void set_rotation(const Quat4& newOrientation) { m_Orientation = m_LastOrientation = newOrientation; }
	const Quat4& rotation() const { return m_Orientation; }

	void set_scale(const Vec3& newScale) { m_Scale = newScale; }

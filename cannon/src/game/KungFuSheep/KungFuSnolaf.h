...
private:
	...
	// Data
	GameEntityPtr								m_FootStepImpactFX;
	GameEntityPtr								m_PoofDeathFX;
	GameEntityPtr								m_DecapitatedHead;
	GameEntityPtr								m_TopHalfOfBody;
	GameEntityPtr								m_BottomHalfOfBody;

...
public:
	...
	void										DoSplashSound();
	GameEntityPtr					GetPresent( const int idx ) { return m_PresentsEnt[idx]; }
...
private:
	...
	GameEntityPtr								m_SnolafPrefab;
	GameEntityPtr								m_SheepPrefab;
	...
	GameEntityPtr								m_BLM;
	GameEntityPtr								m_Credits;

	std::vector<GameEntity*>					m_SnolafPool;
	...
	GameEntityPtr								m_PresentsEnt[2];
	GameEntityPtr								m_BridgeBreakDecal;
	GameEntityPtr								m_BridgeExplosionFX;
